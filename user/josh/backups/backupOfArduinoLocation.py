...
##            print(block)
    ...
    def processBlockForTrainCCW(self, block, checkDist, currentDist):
        returnArray = self.checkBlockCCW(block, checkDist, currentDist)
        returnArray = self.stripOfTurnouts(returnArray)
        return returnArray
    
    def processBlockForTrainCW(self, block, checkDist, currentDist):
        returnArray = self.checkBlockCW(block, checkDist, currentDist)
        returnArray = self.stripOfTurnouts(returnArray)
        return returnArray
...
class Train:
    ...
    def __init__(self, train_id, starting_segment):
        ...
        self.sprog_speed_steps_array_1 = [0,.11111,.9628,4.7325,6.944,8.8668,10.3515,11.1621,11.6118,13.0761,14.1569]
