...
class TrainLayout:
    ...
    def __init__(self,train1_start_segment,train1_start_speed,train2_start_segment,train2_start_speed):
        ...
        self.TURNOUT_COLLISION_TIME_BUFFER = 2
        self.TRAIN_COLLISION_DIST_CHECK = 40
        self.TURNOUT_COLLISION_DIST_CHECK = 50
        ...
        for distTuple in frontArray:
            if isinstance(distTuple[0], Train):
                if (distTuple[2] == True):
                    ...
                    print("Train was False, not included. ---------------- - -- ------------------- - -  - -- - -- - - -")
        ...
        #traverse turnouts that are in opposite directions
            ...
            for distTuple in frontArray:
                if(isinstance(distTuple[0], Turnout) and distTuple[0].orientation != checkTrain.direction):
                    ...
                    print("Array Straight for turnout: " + str(ArrayStraight))
                    print("Array Turn for turnout: " + str(ArrayTurn))
                    if len(ArrayStraight) == 1 and len(ArrayTurn) == 1 and ArrayStraight[0][0].train_id != ArrayTurn[0][0].train_id and ArrayStraight[0][2] == True and ArrayTurn[0][2] == True:
                        print("Inside of check for turnout collision")
                        ...
                        if abs(train1TimeToTurnout - train2TimeToTurnout) <= self.TURNOUT_COLLISION_TIME_BUFFER:
                            ...
                            if(train1TimeToTurnout > train2TimeToTurnout):
                                ...
                                if(potential_solution_found == False):
                                    ...
                                    self.changeTrainSpeed(train1,0.6)
                                    self.changeTrainSpeed(train2,-0.6)
                                    return # Stop looking for collisions, fix is in place
...
##                new_speed = 0.2
##                self.state = 0
##            os.system("python /home/pi/teamge/user/Matt/changeSpeedOfficial.py " + str(self.trains[0].train_id) + " " + str(new_speed))
...
##            self.trains[0].setNewSPROGSpeed(new_speed)
        ...
        if train_to_update == None:
            ...
            print("train to update is empty")
...
class Train:
    ...
    def __init__(self, train_id, starting_segment):
        ...
        self.sprog_speed_steps_array_5 = [0,.3333,2.746,5.811,8.405,10.210,11.247,12.123,12.845,13.311,13.674]
    ...
    def setNewSPROGSpeed(self, sprog_speed):
        ...
        if(sprog_speed != self.sprog_speed):
            ...
            print(self.sprog_speed)
            print(int(self.sprog_speed))
            print(str(self.sprog_speed*10))
            print(int(round(self.sprog_speed*10)))
            ...
            print("Calculated new speed: " + str(calculated_new_speed))
