...
class BeamBreakerBank:
	...
	if(self.turn == 0):
            os.system("python /home/pi/teamge/user/josh/CommunicationSendTest.py " + pi2IP + " 6,19")
            os.system("sudo python /home/pi/teamge/user/Matt/setRed.py")
            #Set to middle loop
            self.turn = (self.turn + 1) % 3
        elif(self.turn == 1):
            #Set to Outer loop
            os.system("python /home/pi/teamge/user/josh/CommunicationSendTest.py " + pi2IP + " 26")
            os.system("sudo python /home/pi/teamge/user/Matt/setGreen.py")
            self.turn = (self.turn + 1) % 3
        elif(self.turn == 2):
            #Set to inner loop
            os.system("python /home/pi/teamge/user/josh/CommunicationSendTest.py " + pi2IP + " 13")
            os.system("sudo python /home/pi/teamge/user/Matt/setYellow.py")
            self.turn = (self.turn + 1) % 3
        #print self.turn
